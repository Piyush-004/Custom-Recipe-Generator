...
def generate_tutorial(components):
    response = openai.chat.completions.create(
        ...
        messages=[{
            ...
            "role": "user",
            "content": f"Suggest a reciepe using the items listed available. Make sure you have a nice name for the reciepe. Also include a funny version of the name. Then share the reciepe in step by step manner. In the end write a fun fact about the reciepe. Here is the items available {components}, Chilli powder, Salt, Tomato Ketchup, Oil and Water."
        }])
